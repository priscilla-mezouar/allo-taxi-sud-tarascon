...
<script>
  ...
  <?php include('./includes/head-links.php'); ?>
    ...
    <title>
      Demande de devis | Allo Taxi Sud Tarascon - Votre taxi 7 jours/7 à
      Tarascon
    </title>
    <meta
      name="description"
      content="Obtenez un devis gratuit pour votre trajet avec Allo Taxi Sud Tarascon. Disponible 7j/7 à Tarascon et ses alentours. Trajets toutes distances, confort et ponctualité garantis." />
    <meta
      name="keywords"
      content="demande de devis taxi, taxi Tarascon, VTC Tarascon, transport médical, devis transport VSL, devis taxi mariage, Allo Taxi Sud Tarascon, devis taxi personnalisé" />
    <link
      rel="canonical"
      href="https://allo-taxi-gambetta-tarascon.fr/demande-de-devis.php" />
    ...
    <meta
    property="og:url"
      content="https://allo-taxi-gambetta-tarascon.fr/demande-de-devis.php" />
          ...
          <div class="item-contact">
            ...
            <ul>
              <li>
                ...
                Devant la mairie, 8 rue Marcel Honorat, 13990 Tarascon
                <br />
              </li>
              <!-- <li>
                <i class="bi bi-geo-fill"></i>
            ...
            <ul>
              ...
              <li>
                ...
                <a href="tel:0609958676">
                  <span> Allo Taxi Tarascon : </span><br />
                  06.09.95.86.76</a
                >
              </li>
              <!-- <li>
