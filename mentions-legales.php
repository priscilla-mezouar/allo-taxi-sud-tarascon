...
<script>
  ...
  <?php include('./includes/head-links.php'); ?>
    ...
    <link
      rel="canonical"
      href="https://allo-taxi-gambetta-tarascon.fr/mentions-legales.php" />
 

    <!-- Open Graph (Facebook & LinkedIn) -->
    <meta
      property="og:title"
      content="Politique de confidentialité - Allo Taxi Sud Tarascon" />
    <meta
    ...
    <meta
      property="og:url"
      content="https://allo-taxi-gambetta-tarascon.fr/mentions-legales.php" />
    ...
    <main role="main">
      ...
      <section class="card">
        ...
        <p>
          ...
          du site allo-taxi-gambetta-tarascon.fr l’identité des différents
          ...
          Louis Chabran Taxi –
          <a href="mailto:contact@allo-taxi-gambetta-tarascon.fr"
            >contact@allo-taxi-gambetta-tarascon.fr</a
          >.
          <br />
      ...
      <section class="card">
        ...
        <p>
          L’utilisation du site allo-taxi-gambetta-tarascon.fr implique
          ...
          allo-taxi-gambetta-tarascon.fr sont donc invités à les consulter de
          manière régulière.
          <br /><br />
          ...
          <br /><br />
          Le site allo-taxi-gambetta-tarascon.fr est mis à jour régulièrement par la
      ...
      <section class="card">
        ...
        <p>
          Le site Allo Taxi Sud Tarascon a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
          <br /><br />
          Allo Taxi Sud Tarascon s’efforce de fournir sur le site
          allo-taxi-gambetta-tarascon.fr des informations aussi précises que
          ...
          informations.
          <br /><br />
          Tous les informations indiquées sur le site Allo Taxi Sud Tarascon sont données
          à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site Allo Taxi Sud Tarascon ne sont pas
      ...
      <section class="card">
        ...
        <p>
          Allo Taxi Sud Tarascon est propriétaire des droits de propriété intellectuelle
          ...
          préalable de : Allo Taxi Sud Tarascon.
          <br /><br />
      ...
      <section class="card">
        ...
        <p>
          ...
          relatives à la protection des données. Le cas échéant, Allo Taxi Sud Tarascon
      ...
      <section class="card">
        ...
        <p>
          ...
          octobre 1995.
          <br /><br />
          A l’occasion de l’utilisation du site allo-taxi-gambetta-tarascon.fr,
          peuvent êtres recueillies : l’URL des liens par l’intermédiaire
          desquels l’utilisateur a accédé au site allo-taxi-gambetta-tarascon.fr, le
          ...
          services proposés par le site allo-taxi-gambetta-tarascon.fr (prise de
          ...
          l’utilisateur du site allo-taxi-gambetta-tarascon.fr l’obligation ou non
          ...
          allo-taxi-gambetta-tarascon.fr n’est publiée à l’insu de l’utilisateur,
          échangée, transférée, cédée ou vendue sur un support quelconque à des
          tiers. Seule l’hypothèse du rachat de Allo Taxi Sud Tarascon et de ses droits
          ...
          du site allo-taxi-gambetta-tarascon.fr.
          <br /><br />
      ...
      <section class="card">
        ...
        <p>
          Le site allo-taxi-gambetta-tarascon.fr contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          Allo Taxi Sud Tarascon. Cependant, Allo Taxi Sud Tarascon n’a pas la possibilité de
          vérifier le contenu des sites ainsi visités, et n’assumera en
          conséquence aucune responsabilité de ce fait.
          <br /><br />
          La navigation sur le site allo-taxi-gambetta-tarascon.fr est susceptible
      ...
      <section class="card">
        ...
        <p>
          ...
          allo-taxi-gambetta-tarascon.fr est soumis au droit français.
        </p>
      </section>
