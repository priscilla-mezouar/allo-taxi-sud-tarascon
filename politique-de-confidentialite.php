...
<script>
  ...
  <?php include('./includes/head-links.php'); ?>
    ...
    <title>
      Politique de confidentialité | Allo Taxi Sud Tarascon - Votre taxi 7
      jours/7 à Tarascon et ses alentours
    </title>
    <meta
      name="description"
    ...
    <link
      rel="canonical"
      href="https://allo-taxi-gambetta-tarascon.fr/politique-de-confidentialite.php" />
    ...
    <meta
      property="og:url"
      content="https://allo-taxi-gambetta-tarascon.fr/politique-de-confidentialite.php" />
